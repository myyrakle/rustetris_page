...
function __wbg_adapter_26(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3a8895f9848e132f(arg0, arg1);
}
...
function __wbg_adapter_29(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2aa4de1247cbb51e(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_32(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7c87dc91d4ff9e56(arg0, arg1);
}

function __wbg_adapter_35(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2be5002841488fa3(arg0, arg1, addHeapObject(arg2));
}
...
* @param {number} x
* @param {number} y
* @param {number} block_width_size
* @param {number} block_height_size
* @param {string} color
*/
export function draw_block(context, x, y, block_width_size, block_height_size, color) {
    const ptr0 = passStringToWasm0(color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.draw_block(addHeapObject(context), x, y, block_width_size, block_height_size, ptr0, len0);
}
...
* @param {number} hidden_row_count
*/
export function render_board(board_unfolded, board_width, board_height, column_count, row_count, hidden_row_count) {
    const ptr0 = passArray32ToWasm0(board_unfolded, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.render_board(ptr0, len0, board_width, board_height, column_count, row_count, hidden_row_count);
}

/**
* @param {Int32Array} mino_list
* @param {number} board_width
* @param {number} board_height
* @param {number} column_count
* @param {number} row_count
*/
export function render_next(mino_list, board_width, board_height, column_count, row_count) {
    const ptr0 = passArray32ToWasm0(mino_list, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.render_next(ptr0, len0, board_width, board_height, column_count, row_count);
}

/**
* @param {number | undefined} mino
* @param {number} board_width
* @param {number} board_height
* @param {number} column_count
* @param {number} row_count
*/
export function render_hold(mino, board_width, board_height, column_count, row_count) {
    wasm.render_hold(!isLikeNone(mino), isLikeNone(mino) ? 0 : mino, board_width, board_height, column_count, row_count);
}

/**
*/
export function run_render() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.run_render(retptr);
...
function getImports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper445 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 164, __wbg_adapter_29);
        return addHeapObject(ret);
    };
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('rustetris-970637a456b22ce3_bg.wasm', import.meta.url);
    }
    const imports = getImports();
