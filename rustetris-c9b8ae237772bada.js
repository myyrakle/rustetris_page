...
function __wbg_adapter_26(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1d253964862127ef(arg0, arg1);
}
...
*/
export function render_board(board_unfolded, board_width, board_height, column_count, row_count) {
    const ptr0 = passArray32ToWasm0(board_unfolded, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.render_board(ptr0, len0, board_width, board_height, column_count, row_count);
}
...
function getImports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper436 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 159, __wbg_adapter_29);
        return addHeapObject(ret);
    };
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('rustetris-c9b8ae237772bada_bg.wasm', import.meta.url);
    }
    const imports = getImports();
